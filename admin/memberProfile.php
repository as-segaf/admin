          ...
          <div class="col-md-9">
            <div class="box-primary">
                <div class="box box-info">
                  ...
                  <!-- /.box-header -->
                  <!-- form start -->
                  <form class="form-horizontal" method="post" action="updateMember.php?id=<?php echo $data['id']; ?>">
                    <div class="box-body">
                      <div class="form-group">
                        <label class="col-sm-2 control-label">Old Password</label>

                        <div class="col-sm-10">
                          <input type="text" class="form-control" name="oldPass" value="<?php echo $data['password']; ?>">
                        </div>
                      </div>
                      <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-10">
                          <input type="text" class="form-control" name="newPass1" placeholder="Re-type new password">
                        </div>
                      </div>
                    </div>
                    <!-- /.box-body -->
