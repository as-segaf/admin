        ...
        <section class="col-lg-12 connectedSortable">                
          ...
          <div class="box box-info">
            <div class="box-header with-border">
              <button class="btn btn-primary" data-toggle="modal" data-target="#modal-info">Add a Member</button>
            </div>
            <div class="box-body">
              <!-- modal -->
              ...
              <div class="row">
                <?php 
                  $select = mysqli_query($host, "SELECT username FROM user WHERE role=1 OR role=0");
