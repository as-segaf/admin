          ...
          <div class="col-md-9">
            <div class="box-primary">
                <div class="box box-info">
                  ...
                  <!-- /.box-header -->
                  <!-- form start -->
                  <form class="form-horizontal" method="post" action="update.php?id=<?php echo $_SESSION['id_user']; ?>">
                    <div class="box-body">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-10">
                          <input type="password" class="form-control" name="newPass1" placeholder="Re-type your new password">
                        </div>
                      </div>
                    </div>
                    <!-- /.box-body -->
